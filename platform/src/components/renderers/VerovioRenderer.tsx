// ::: Code Generated by Copilot 3d422051-20c2-48c6-b8af-c040b4f20d70. This comment will be removed automatically after the file is saved :::
"use client";
...
function loadVerovioScript(): Promise<void> {
  ...
  scriptLoadPromise = new Promise<void>((resolve, reject) => {
    ...
    const existing = document.querySelector(`script[src="${VEROVIO_SCRIPT_PATH}"]`);
    if (existing) {
    ...
    script.src = VEROVIO_SCRIPT_PATH;
    script.async = true;
    script.onload = () => waitForVerovio(resolve, reject);
    script.onerror = () => reject(new Error(`Failed to load Verovio script from ${VEROVIO_SCRIPT_PATH}`));
